...
case "TABELLE":  			$messaggio = "TABLAS"; break;
...
case "SPESE":  				$messaggio = "GASTOS"; break;
case "CASSE":  				$messaggio = "CAJAS"; break;
case "TARIFFE":  			$messaggio = "TARIFAS"; break;
case "CLIENTI":  			$messaggio = "CLIENTES"; break;
case "INSERIRE":  			$messaggio = "INSERTAR"; break;
case "CLIENTE":  			$messaggio = "CLIENTE"; break;
case "PREZZI":  			$messaggio = "PRECIOS"; break;
case "REGOLE":  			$messaggio = "REGLAS"; break;
case "CONFIGURA":  			$messaggio = "CONFIGURAR"; break;
case "TUTTE":  				$messaggio = "TODAS"; break;
case "CORRENTI":  			$messaggio = "ACTUALES"; break;
case "FUTURE":  			$messaggio = "FUTURAS"; break;
case "ARRIVI":  			$messaggio = "LLEGADAS"; break;
case "PARTENZE":  			$messaggio = "SALIDAS"; break;
case "MESSAGGI":  			$messaggio = "MENSAJES"; break;
case "ENTRATE&nbsp;PREN.":  		$messaggio = "PAGOS&nbsp;RESER."; break;
case "UTENTI":  			$messaggio = "USUARIOS"; break;
case "SITO WEB":  			$messaggio = "SITIO WEB"; break;
case "INTERCONN.":  			$messaggio = "INTERCON."; break;
case "BACKUP":  			$messaggio = "BACKUP"; break;
case "STATISTICHE":  			$messaggio = "ESTAD&Iacute;STICAS"; break;
case "INVENTARIO":  			$messaggio = "INVENTARIO"; break;
case "CERCA":  				$messaggio = "BUSCAR"; break;
case "DOCUMENTI":  			$messaggio = "DOCUMENTOS"; break;
case "P.TO&nbsp;VENDITA":  		$messaggio = "P.TO&nbsp;DE&nbsp;VENTA"; break;
case "NUMERO":  			$messaggio = "NÚMERO"; break;
case "VAI":  				$messaggio = "IR"; break;
case "COSTI AGGIUNTIVI":  		$messaggio = "COSTES AÑADIDOS"; break;
case "CAPARRE E TASSE":  		$messaggio = "FIANZAS Y TASAS"; break;
case "PARTENZE E CORRENTI":  		$messaggio = "SALIDAS Y CORRIENTES"; break;
