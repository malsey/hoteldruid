...
echo "</select>
<input class=\"sbutton\" type=\"submit\" name=\"elimina_campo_pers_comm\" value=\"".mex("elimina",$pag)."\">&nbsp;&nbsp;&nbsp;";
} # fine if ($campi_pers_comm)
echo " <input type=\"text\" name=\"nuovo_campo_comm\" size=\"12\" maxlength=\"30\">
<input class=\"sbutton\" type=\"submit\" name=\"aggiungi_campo_pers_comm\" value=\"".mex("aggiungi",$pag)."\">
</div></form><hr style=\"width: 95%\">
...
</select> <input class=\"sbutton\" type=\"submit\" name=\"cambia_ordine_inventario\" value=\"".mex("Cambia",$pag)."\">
...
<input type=\"hidden\" name=\"num_tasti_pos\" value=\"".($num_tasti_pos + 2)."\">
 <input class=\"sbutton\" type=\"submit\" name=\"cambia_tasti_pos\" value=\"".mex("Cambia",$pag)."\">
</div></form><hr style=\"width: 95%\">";
